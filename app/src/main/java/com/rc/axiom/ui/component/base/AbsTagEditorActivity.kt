...
import com.rc.axiom.databinding.ActivityTagEditorBinding
import com.rc.axiom.extensions.*
...
abstract class AbsTagEditorActivity : AbsBaseActivity(),
    ...
    protected open fun selectImage() {
        val items = arrayOf(
            getString(com.rc.axiom.R.string.download_image),
            getString(com.rc.axiom.R.string.pick_from_local_storage),
            getString(com.rc.axiom.R.string.web_search),
            getString(com.rc.axiom.R.string.restore_default),
            getString(com.rc.axiom.R.string.remove_cover)
        )
        MaterialAlertDialogBuilder(this)
            .setTitle(com.rc.axiom.R.string.update_image)
    ...
    private fun writeTags() {
        viewModel.write(this, propertyMap).observe(this) { result ->
            if (result.isLoading) {
                ...
                showToast(com.rc.axiom.R.string.saving_changes)
            } else {
                binding.actionSave.show()
                if (result.isSuccess) {
                    showToast(com.rc.axiom.R.string.changes_saved_successfully)
                } else {
                    showToast(com.rc.axiom.R.string.could_not_save_some_changes)
                }
            }
        }
    }
