package com.rc.axiom.ui.screen
...
import com.rc.axiom.core.model.MediaEvent
import com.rc.axiom.data.model.network.NetworkFeature
import com.rc.axiom.extensions.currentFragment
import com.rc.axiom.extensions.navigation.isValidCategory
import com.rc.axiom.extensions.showToast
import com.rc.axiom.extensions.whichFragment
import com.rc.axiom.playback.Playback
import com.rc.axiom.playback.library.MediaIDs
import com.rc.axiom.core.model.shuffle.OpenShuffleMode
import com.rc.axiom.ui.IScrollHelper
import com.rc.axiom.ui.component.base.AbsSlidingMusicPanelActivity
import com.rc.axiom.ui.screen.update.UpdateDialog
...
class MainActivity : AbsSlidingMusicPanelActivity(), MediaController.Listener {
    ...
    companion object {
        private const val APP_SHORTCUT_LAST_ADDED = "com.rc.axiom.shortcut.LAST_ADDED"
        private const val APP_SHORTCUT_TOP_TRACKS = "com.rc.axiom.shortcut.TOP_TRACKS"
        private const val APP_SHORTCUT_SHUFFLE = "com.rc.axiom.shortcut.SHUFFLE"
        private const val APP_SHORTCUT_FAVORITES = "com.rc.axiom.shortcut.FAVORITES"

        private val OLD_SHORTCUT_IDS = listOf(
            "com.rc.axiom.appshortcuts.id.last_added",
            "com.rc.axiom.appshortcuts.id.top_tracks",
            "com.rc.axiom.appshortcuts.id.shuffle_all",
        )
    }
}