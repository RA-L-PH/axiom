package com.rc.axiom.coil.fetcher
...
import com.rc.axiom.coil.model.AudioCover
import com.rc.axiom.coil.util.AudioCoverUtils
import com.rc.axiom.data.local.repository.Repository
import com.rc.axiom.data.model.network.NetworkFeature
import com.rc.axiom.extensions.media.asAlbumCoverUri
import com.rc.axiom.extensions.media.isArtistNameUnknown
import com.rc.axiom.util.ImageSize
...
class AudioCoverFetcher(
    ...
    override suspend fun fetch(): FetchResult? {
        ...
        if (stream == null &&
            ...
            NetworkFeature.Images.Albums.isEnabled && NetworkFeature.isOnline(ignoreWifiSetting = true)) {
