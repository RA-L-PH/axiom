...
import com.rc.axiom.extensions.resources.createAxiomBalloon
...
inline fun Fragment.createAxiomBalloon(
    tooltipId: String,
    crossinline block: Balloon.Builder.() -> Unit
) = requestContext { it.createAxiomBalloon(tooltipId, viewLifecycleOwner, block = block) }
