...
import com.rc.axiom.coil.CoilBitmapLoader
import com.rc.axiom.core.appwidgets.AxiomGlanceWidget
import com.rc.axiom.core.appwidgets.CardWidget
import com.rc.axiom.core.appwidgets.FullWidget
import com.rc.axiom.core.appwidgets.WidgetTheme
...
import com.rc.axiom.core.model.player.MetadataField
import com.rc.axiom.core.palette.PaletteProcessor
import com.rc.axiom.data.local.MediaStoreObserver
import com.rc.axiom.data.local.ReplayGainTagExtractor
...
import com.rc.axiom.extensions.isBluetoothA2dpConnected
import com.rc.axiom.extensions.isBluetoothA2dpDisconnected
import com.rc.axiom.extensions.showToast
import com.rc.axiom.playback.equalizer.EqualizerManager
import com.rc.axiom.playback.library.LibraryProvider
import com.rc.axiom.playback.library.MediaIDs
...
import com.rc.axiom.playback.renderer.AlacWorkaroundCodecSelector
import com.rc.axiom.playback.renderer.AxiomRenderersFactory
import com.rc.axiom.ui.screen.MainActivity
import com.rc.axiom.util.CLEAR_QUEUE_ON_COMPLETION
import com.rc.axiom.util.ENABLE_HISTORY
import com.rc.axiom.util.IGNORE_AUDIO_FOCUS
import com.rc.axiom.util.MP3_INDEX_SEEKING
import com.rc.axiom.util.PAUSE_ON_ZERO_VOLUME
import com.rc.axiom.util.PLAY_ON_STARTUP_MODE
import com.rc.axiom.util.PlayOnStartupMode
import com.rc.axiom.util.Preferences
import com.rc.axiom.util.Preferences.requireString
import com.rc.axiom.util.QUEUE_NEXT_MODE
import com.rc.axiom.util.REWIND_WITH_BACK
import com.rc.axiom.util.SEEK_INTERVAL
import com.rc.axiom.util.STOP_WHEN_CLOSED_FROM_RECENTS
import com.rc.axiom.util.SongPlayCountHelper
import com.rc.axiom.util.WIDGET_DYNAMIC_COLORS
import com.rc.axiom.util.WIDGET_IMAGE_CORNER_RADIUS
import com.rc.axiom.util.WIDGET_SMALL_LAYOUT_STYLE
import com.rc.axiom.util.WIDGET_THIRD_LINE_CONTENT
...
class PlaybackService :
    ...
    private val playerThread = HandlerThread("Axiom-ExoPlayer", Process.THREAD_PRIORITY_AUDIO)
    ...
    override fun onCreate() {
        ...
        player = AdvancedForwardingPlayer(
            ExoPlayer.Builder(this)
                ...
                .setRenderersFactory(
                    AxiomRenderersFactory(this, balanceProcessor, replayGainProcessor)
    ...
    private suspend fun updateGlanceWidgets(playbackState: PlaybackState) = withContext(IO) {
        try {
            val axiomWidget = AxiomGlanceWidget()
            val axiomWidgetIds = glanceManager.getGlanceIds(axiomWidget.javaClass)
            if (axiomWidgetIds.isNotEmpty()) {
                axiomWidgetIds.forEach { id ->
                    updateAppWidgetState(applicationContext, PlaybackStateDefinition, id) {
                        playbackState
                    }
                    axiomWidget.update(applicationContext, id)
                }
            }
    ...
    companion object {
        private const val PACKAGE_NAME = "com.rc.axiom"
