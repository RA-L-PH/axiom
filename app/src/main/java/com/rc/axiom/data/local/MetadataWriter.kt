package com.rc.axiom.data.local
...
import com.rc.axiom.extensions.media.createAlbumArtThumbFile
import com.rc.axiom.extensions.media.deleteAlbumArt
import com.rc.axiom.extensions.media.insertAlbumArt
...
class MetadataWriter : KoinComponent {
    ...
    private fun createPicture(target: EditTarget): Picture? {
        ...
        return Picture(
            data = byteArray,
            description = "Embedded Front Cover - axiom",
