 ...
 */
package com.rc.axiom.data.remote.github

import android.content.Context
import com.rc.axiom.data.remote.github.model.GitHubRelease
import com.rc.axiom.util.Constants.GITHUB_API_URL
...
class GitHubService(private val context: Context, private val client: HttpClient, private val authToken: String? = null) {
    ...
    companion object {
        private const val DEFAULT_USER = "rc"
        private const val DEFAULT_REPO = "Axiom"
    }
}