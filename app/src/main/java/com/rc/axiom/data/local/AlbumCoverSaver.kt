...
import com.rc.axiom.extensions.resources.toJPG
import com.rc.axiom.util.FileUtil
...
class AlbumCoverSaver(
    ...
    private fun saveBitmap(bitmap: Bitmap): Uri? {
        val request = MediaStoreWriter.Request.forImage(
            ...
            subFolder = FileUtil.AXIOM_ARTWORK_DIRECTORY_NAME,
    ...
    private fun saveBitmapAsFile(bitmap: Bitmap): File? {
        return mediaStoreWriter.toFile(
            directory = FileUtil.imagesDirectory(FileUtil.AXIOM_ARTWORK_DIRECTORY_NAME),
