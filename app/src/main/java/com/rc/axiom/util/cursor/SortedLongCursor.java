 ...
 */
package com.rc.axiom.util.cursor;
...
/**
 * This cursor basically wraps a song cursor and is given a list of the order of
 * the ids of the
 * contents of the cursor. It wraps the Cursor and simulates the internal cursor
 * being sorted
...
public class SortedLongCursor extends AbstractCursor {
     ...
     */
    public SortedLongCursor(final @NonNull Cursor cursor, final @NonNull long[] order,
    ...
    /**
     * This function populates mOrderedPositions with the cursor positions in the
     * order based
    ...
    private ArrayList<Long> buildCursorPositionMapping(@Nullable final long[] order, final String columnName) {
        ...
        // this contains the mapped cursor positions and afterwards the extra ids that
        // weren't found
